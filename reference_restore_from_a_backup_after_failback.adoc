---
permalink: reference_restore_from_a_backup_after_failback.html
sidebar: sidebar
...
xref:task_restore_a_virtual_machine_from_a_backup_copy.adoc[Restore a virtual machine from a backup copy]
